package com.kirillpolyakov.quizspringbootadminclient;

import com.kirillpolyakov.quizspringbootadminclient.controller.ControllerData;
...
public class App extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        Scene scene = new Scene(fxmlLoader.load(), 226, 204);
