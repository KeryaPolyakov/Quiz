...
public class RequestRepository {
    ...
    public RequestRepository(String userName, String password) {
        objectMapper = new ObjectMapper();
        objectMapper.registerModule(new JavaTimeModule());
    ...
    public List<Request> getAllByUser(long userId) throws IOException {
        Response<ResponseResult<List<Request>>> execute = service.getAllByUser(userId).execute();
